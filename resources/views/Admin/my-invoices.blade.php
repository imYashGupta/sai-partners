...
<!-- Mirrored from expert-themes.com/html/ourland/admin/my-invoices.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Sep 2019 09:25:58 GMT -->
<head>
<meta charset="utf-8">
<title>Ourland - Real Estate HTML Template | My Invoices</title>
<!-- Stylesheets -->
    ...
    <section class="hidden-bar">
        <div class="dashboard-inner">
        	...
        	<ul class="navigation">
	            ...
	            <li><a href="../index.html"><i class="pe-7s-back-2"></i>Logout</a></li>
	        </ul>
	    </div>
    </section>
    <!--End Hidden Bar -->
