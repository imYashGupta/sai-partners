...
<div class="dashboard-content">
    <div class="dashboard-header clearfix">
        <div class="row">
            ...
            <h4>Users Listed Properties</h4></div>
            <div class="col-md-6 col-sm-12">
    ...
    <div class="row">
        <div class="column col-lg-12">
            <div class="properties-box">
                <div class="title">
                <h3>User Listed Properties</h3></div>
                <div class="inner-container">
                    ...
                    <div class="message-box pl-0 mt-3 m-0" style="min-height: 0 !important;">
                        <div class="btn-box">
                                <a @click.prevent="approveProperty('property_{{ $property->id }}',{{ $property->id }})" href="#">Approve <i class="pe-7s-check"></i></a>
                                <a href="{{ route("deleteProperty",encrypt($property->id)) }}" @click.prevent="deletePropertyDialog($event,'property_{{ $property->id }}')">Reject <i class="pe-7s-close-circle"></i></a>
                            </div>
                    </div>
                </div>
                @endforeach
