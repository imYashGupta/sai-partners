													...
													<tr>
														<td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
															<div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;">
																<p>Hello, {{ $name }}</p>
																<p class="hero">Your Listed Property has Been Approved and listed on our website.</p>
																<p><a href="{{ route("propertyDetail",$id) }}">Click Here</a> to view the property you submited.</p>
																<p>Thanks for submiting your property to our website.</p>
																<hr style="margin-top: 56px">
																<p class="mb-0">Thanks and Regards,</p>
