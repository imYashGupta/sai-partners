																...
																<tbody>
																	<tr>
																		<td style="width:150px;">
																			<img alt="Logo" title="" height="auto" src="http://saipartnerbuilders.com/images/sai-logo-chang.png" style="border:none;border-radius:0px;display:block;font-size:13px;outline:none;text-decoration:none;width:100%;height:auto;" width="150">
																		</td>
																	</tr>
																</tbody>
															</table>
													...
													<tr>
														<td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
															<div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;">
																<p>Hello, Admin</p>
																<p class="hero">{{ $name }} has Submited a property.</p>
																<p>Please review this property <a href="{{ route("userProperties") }}">Review Property</a></p>
																{{-- <p>To Review All User listed property <a href="{{ route("userProperties") }}">Click Here</a></p> --}}
																<p>User will recive a email notification if you approve the property.</p>
																<hr style="margin-top: 56px">
																<p class="mb-0">Thanks,</p>
																<p class="mb-0">Sai Partners & Builders</p>
															</div>
														</td>
													</tr>
												</tbody>
