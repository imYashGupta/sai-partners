													...
													<tr>
														<td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
															<div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;">
																<p>Hello, {{ $name }}</p>
																<p class="hero">Thanks for submiting your property to our website.</p>
																<p>Your listed property is being Reviewed by our staff and will be approved if matches all our standard.</p>
																<p>You'll recive a email when your listed property get approved!</p>
